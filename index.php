...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Fahkwang:wght@200;500&display=swap" rel="stylesheet">
    <style>
        .Bgarea{
            background-color: rgb(238, 146, 189);
            border-radius: 2px;
            padding: 25px;
            font-size: 36px;
        }
...
<body>
        ...
        <h1 align=center class = "Bgarea">Blink Cafe</h1>
        <table class="table">
